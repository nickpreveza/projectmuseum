...
public class vp_Grab : vp_Interactable
{
	...
	protected override void Start()
	{
		...
		if (Rigidbody != null)
		{
			...
			m_DefaultDrag = Rigidbody.linearDamping;
			m_DefaultAngularDrag = Rigidbody.angularDamping;
		}
	...
	protected virtual void StartGrab()
	{
		...
		if (Rigidbody != null)
		{
			...
			Rigidbody.linearDamping = (Stiffness * 60.0f);
			Rigidbody.angularDamping = (Stiffness * 60.0f);
		}
	...
	protected virtual void StopGrab()
	{
		...
		if (Rigidbody != null)
		{
			...
			Rigidbody.linearDamping = m_DefaultDrag;
			Rigidbody.angularDamping = m_DefaultAngularDrag;
		}
